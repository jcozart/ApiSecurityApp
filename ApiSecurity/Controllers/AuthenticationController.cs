...
public class AuthenticationController : ControllerBase
{
    ...
    {
        // THIS IS NOT PRODUCTION CODE - Simulating going to a database to check username and password match
        if(CompareValues(data.UserName, "jcozart") &&
           CompareValues(data.Password, "Test123"))
        {
            return new UserData(1, data.UserName!, "Business Owner", "E001");
        }

        if (CompareValues(data.UserName, "bdedmond") &&
            CompareValues(data.Password, "Test123"))
        {
